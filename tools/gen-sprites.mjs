...
const icons = [
  ...
  { name: 'ammo_shell', colors: {
    ...
    '................' ] },
  // ---------------- 장비/컨테이너 ----------------
  // 전투 헬멧: 돔 셸(좌상단 하이라이트) + 바이저 밴드 + 턱끈
  { name: 'equip_helmet', colors: {
    ...
    '................',
    '................' ] },
  // 방탄 조끼: 몸통 패널 + 어깨끈 + 중앙 지퍼/파우치
  { name: 'equip_armor', colors: {
    ...
    '..KKKKKKKKKKKK..',
    '................' ] },
  // 전술 리그: 낮은 조끼 + 세 개의 파우치(내부 그리드 암시)
  { name: 'equip_rig', colors: {
    ...
    '..KKKKKKKKKKKK..',
    '................' ] },
  // 배낭: 둥근 메인 포켓 + 상단 뚜껑 + 옆 스트랩
  { name: 'equip_backpack', colors: {
