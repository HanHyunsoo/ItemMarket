...
// drag that starts in one grid (e.g. Stash) can be dropped on another (Loadout).
// Only one drag can be in flight at a time, so a single module-level ref is enough.
