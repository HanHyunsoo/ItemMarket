...
export const adminApi = {
  ...
  adjustWallet: (body: AdminAdjustWalletRequest) => api.post<WalletDto>('/api/admin/wallet/adjust', body),
  grantStack: (body: AdminGrantStackRequest) => api.post<InventoryDto>('/api/admin/grant/stack', body),
  ...
  trades: (page: number, size: number) => api.get<PagedResult<TradeDto>>('/api/admin/trades', { page, size }),
}
